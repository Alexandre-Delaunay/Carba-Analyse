...
KUHL_M_SEKURLSA_PACKAGE kuhl_m_sekurlsa_tspkg_package = {_CT_("tspkg"), kuhl_m_sekurlsa_enum_logon_callback_tspkg, TRUE, _CT_("tspkg.dll"), {{{NULL, NULL}, 0, NULL}, FALSE, FALSE}};
/*
