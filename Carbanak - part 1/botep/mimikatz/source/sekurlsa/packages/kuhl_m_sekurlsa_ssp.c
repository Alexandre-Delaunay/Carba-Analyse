...
KUHL_M_SEKURLSA_PACKAGE kuhl_m_sekurlsa_ssp_package = {_CT_("ssp"), kuhl_m_sekurlsa_enum_logon_callback_ssp, TRUE, _CT_("msv1_0.dll"), {{{NULL, NULL}, 0, NULL}, FALSE, FALSE}};
